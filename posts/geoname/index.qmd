...
{{< video https://www.youtube.com/embed/GCMXwoITHZE?si=9i_lRnyXzq57mDFH >}}
...
nga_dhs <- sntutils::read(
  # here::here("01_data/dhs/Admin2_NGDHS2018Table.xlsx")
  "01_data/dhs/Admin2_NGDHS2018Table.xlsx"
) |>
  dplyr::select(
    adm0 = adm0_name,
    adm1 = adm1_name,
...
# cache_path <- here::here("01_data/cache/geoname_cleaning_nga.rds")
cache_path <- "01_data/cache/geoname_cleaning_nga.rds"
unmatched_path <- ("01_data/cache/nga_unmatched_adm2.rds")
...
nga_dhs_edge <- sntutils::read(
  # here::here("01_data/dhs/Admin2_NGDHS2018Table_edge.xlsx")
  "01_data/dhs/Admin2_NGDHS2018Table_edge.xlsx"
) |>
  dplyr::select(
    adm0 = adm0_name,
    adm1 = adm1_name,
